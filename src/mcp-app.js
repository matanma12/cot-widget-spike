...
const app = new App({ name: "CoT Reasoning Map", version: "0.2.0" });
app.ontoolresult = (result) => {
  if (result.structuredContent?.moves) { trace = result.structuredContent; revealed = Infinity; render(); }
};
app.connect();
window.__renderTrace = (t) => { trace = t; revealed = Infinity; render(); };
